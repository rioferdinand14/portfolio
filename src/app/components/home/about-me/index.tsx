            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p style={{ color: "black", fontSize: "20px"}}>
                  Driven by curiosity and a passion for scalable tech, I
                  specialize in crafting intelligent software solutions. With a
                  Bachelor’s in Informatics Engineering, my expertise spans from
                  Full-Stack Development to Computer Vision. I thrive in
                  fast-paced environments where teamwork and creative
                  problem-solving are the keys to building the next generation
                  of digital tools.
                </p>
